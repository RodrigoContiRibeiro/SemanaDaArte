...
public class LoadData implements CommandLineRunner {
    @Autowired
    PesquisaServiceImpl repository;

    @Override
    public void run(String... args) throws Exception {
        if (repository.findByTitleIgnoreCase("Pesquisa sobre arte urbana") == null) {
            ...
            pesquisaUrb.setSlug(repository.gerarSlug(pesquisaUrb.getTitle()));
            repository.save(pesquisaUrb);
        }
        if (repository.findByTitleIgnoreCase("Pesquisa sobre a Pop Art") == null) {
            ...
            pesquisaPop.setSlug(repository.gerarSlug(pesquisaPop.getTitle()));
